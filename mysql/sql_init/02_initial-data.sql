...
('user1@local', 'user1pass', 'MR.user1', 'aaa', '2000/01/01', '888-888-888'),
('user2@local', 'user2pass', 'MR.user2', 'bbb', '2000/01/01', '888-888-888'),
('user3@local', 'user3pass', 'MR.user3', 'ccc', '2000/01/01', '888-888-888');
